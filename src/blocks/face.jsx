...
registerBlockType( 'cumulus-gutenberg/imageflip-face', {
	apiVersion: 2,

	title: 'Flip Card Face',

	description: 'Face container for CardFlip blocks',
	...
	parent: [ 'cumulus-gutenberg/imageflip' ],
